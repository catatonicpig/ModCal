...
class TestClass_1:
    ...
    def test_passfunction(self, expectation):
        with expectation:
            assert emulator(passthroughfunc = borehole_model, method = 'PCGPwM') is not None
...
class TestClass_2:
    ...
    def test_passfunction_predict(self, expectation):
        with expectation:
            emu = emulator(passthroughfunc = borehole_model, method = 'PCGPwM')
