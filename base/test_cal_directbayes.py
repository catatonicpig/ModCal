...
emulator_2 = emulator(x = x, theta = theta_lin, f = f_lin, method = 'PCGP_ozge')
...
class TestClass_1:
    ...
    def test_cal_directbayes(self, input1, expectation):
        with expectation:
            assert calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar) is not None
    ...
    def test_cal_predict(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
        with expectation:
...
class TestClass_2:
    ...
    def test_cal_predict_mean(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
    ...
    def test_cal_predict_var(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
        pred_bayes = cal_bayes.predict(x = x)
        with expectation:
    ...
    def test_cal_predict_rnd(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
        pred_bayes = cal_bayes.predict(x = x)
        with expectation:
    ...
    def test_cal_predict_lpdf(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
        pred_bayes = cal_bayes.predict(x = x)
        with expectation:
...
class TestClass_3:
    ...
    def test_cal_thetadist(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
        with expectation:
    ...
    def test_cal_thetadist_repr(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
    ...
    def test_cal_thetadist_call(self, input1, expectation):
        cal_bayes = calibrator(emu = emulator_1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
        with expectation:
    ...
    def test_cal_thetadist_mean(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
        with expectation:
    ...
    def test_cal_thetadist_var(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
        with expectation:
    ...
    def test_cal_thetadist_rnd(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
        with expectation:
    ...
    def test_cal_thetadist_lpdf(self, input1, expectation):
        cal_bayes = calibrator(emu = input1, y = y, x = x, thetaprior = priorphys_lin, method = 'directbayes', yvar = obsvar)
        with expectation:
